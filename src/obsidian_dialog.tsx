...
export const ObsidianDialog = () => {
    const [vaultName, setVaultName] = useState(localStorage.getItem(VAULT_NAME_KEY) || "Personal Vault");
    const [notesPath, setNotesPath] = useState(localStorage.getItem(NOTES_PATH_KEY) || "")
    ...
    const createNote = useCallback(async () => {
        ...
        const url = `obsidian://new?vault=${encodeURIComponent(vaultName.trim())}&file=${encodeURIComponent(notePath)}&content=${encodeURIComponent(markdown)}`;
        window.open(url);
